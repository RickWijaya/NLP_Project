...
export default function ChatPage() {
    ...
    const [messages, setMessages] = useState([
        { role: 'assistant', content: `Hello! I am ${params.botname}, your intelligent assistant. How can I help you today?`, timestamp: '10:30 AM' },
    ]);
    ...
    const simulateAssistantResponse = (userMessage) => {
        setMessages(prevMessages => [
            ...
            { role: 'assistant', content: 'This is a simulated response to: ' + userMessage },
        ]);
    };
